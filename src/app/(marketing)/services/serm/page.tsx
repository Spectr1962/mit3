...
export default async function SermServicePage() {
    let service = null;
    ...
    try {
        ...
        service = await db.service.findUnique({
            where: { slug: "serm-maps" }, // Слаг для вашей услуги управления репутацией
            select: {
                titleH1: true,
                description: true,
                tariffs: true,
        ...
        console.error("База данных недоступна при сборке страницы SERM:", error);
    }
    ...
    if (!service) {
        return (
            <main className="container mx-auto p-8 text-center">
                <h1 className="text-3xl font-bold">Управление репутацией (SERM)</h1>
