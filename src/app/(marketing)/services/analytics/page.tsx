...
export default async function AnalyticsServicePage() {
    let service = null;
    ...
    try {
        ...
        service = await db.service.findUnique({
            where: { slug: "web-analytics" }, // Слаг для сквозной аналитики и аудита
            select: {
                titleH1: true,
                description: true,
                tariffs: true,
        ...
        console.error("База данных недоступна при сборке страницы Analytics:", error);
    }
    ...
    if (!service) {
        return (
            <main className="container mx-auto p-8 text-center">
                <h1 className="text-3xl font-bold">Сквозная веб-аналитика и аудит</h1>
