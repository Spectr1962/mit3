...
export default async function SeoServicePage() {
    ...
    try {
        ...
        service = await db.service.findUnique({
            where: { slug: "seo-audit" }, // Слаг для вашей услуги поискового продвижения
            select: {
                titleH1: true,
                description: true,
                tariffs: true,
        ...
        console.error("База данных недоступна при сборке страницы SEO:", error);
    }
    ...
    if (!service) {
        return (
            <main className="container mx-auto p-8 text-center">
                <h1 className="text-3xl font-bold">Поисковое SEO-продвижение</h1>
    ...
    return (
        <main className="container mx-auto p-8">
            ...
            {/* Вывод тарифов на поисковое продвижение */}
