...
export default async function MarketingServicePage() {
    ...
    try {
        ...
        service = await db.service.findUnique({
            where: { slug: "digital-marketing" }, // Слаг для комплексного маркетинга
            select: {
                titleH1: true,
                description: true,
                tariffs: true,
        ...
        console.error("База данных недоступна при сборке страницы Marketing:", error);
    }
    ...
    if (!service) {
        return (
            <main className="container mx-auto p-8 text-center">
                <h1 className="text-3xl font-bold">Комплексный интернет-маркетинг</h1>
