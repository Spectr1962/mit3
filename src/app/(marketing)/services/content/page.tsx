...
export default async function ContentServicePage() {
    ...
    try {
        ...
        service = await db.service.findUnique({
            where: { slug: "content-management" }, // Слаг для контент-маркетинга и копирайтинга
            select: {
                titleH1: true,
                description: true,
                tariffs: true,
        ...
        console.error("База данных недоступна при сборке страницы Content:", error);
    }
    ...
    if (!service) {
        return (
            <main className="container mx-auto p-8 text-center">
                <h1 className="text-3xl font-bold">Наполнение контентом и копирайтинг</h1>
